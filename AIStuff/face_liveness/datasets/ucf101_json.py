...
if __name__ == '__main__':
    csv_dir_path = 'motion_analysis/annotation'

    for split_index in range(1, 2):
        label_csv_path = os.path.join(csv_dir_path, 'classInd.txt')
        train_csv_path = os.path.join(csv_dir_path, f'trainlist0{split_index}.txt')
        val_csv_path = os.path.join(csv_dir_path, f'testlist0{split_index}.txt')
        dst_json_path = os.path.join(csv_dir_path, f'ucf101_0{split_index}.json')
