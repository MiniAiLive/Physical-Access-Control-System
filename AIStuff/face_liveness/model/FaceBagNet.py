...
def FaceBagNet_model_A(num_classes=3):
...
def FaceBagNet_model_B(num_classes=3):
...
def FaceBagNet_model_C(num_classes=3):
...
class Net(nn.Module):
    def __init__(self, num_class=2, is_first_bn=False, mtype="A"):
        ...
        if mtype == 'A':
            ...
            self.encoder = None #tvm.resnet18(pretrained=False)
...
class FusionNet(nn.Module):
    ...
    def __init__(self, num_class=2, mtype='A', fusion='se_fusion'):
        super(FusionNet, self).__init__()

        self.color_moudle = Net(num_class=num_class, is_first_bn=True, mtype=mtype)
        self.depth_moudle = Net(num_class=num_class, is_first_bn=True, mtype=mtype)
        self.ir_moudle = Net(num_class=num_class, is_first_bn=True, mtype=mtype)
