...
class Residual(Module):
    ...
    def __init__(self, c1, c2, c3, num_block, groups, kernel=(3, 3), stride=(1, 1), padding=(1, 1)):
        ...
        for i in range(num_block):
            ...
            c2_tuple = c2[i]
            c3_tuple = c3[i]
            modules.append(DepthWise(c1_tuple, c2_tuple, c3_tuple, residual=True,
...
class ResidualSE(Module):
    ...
    def __init__(self, c1, c2, c3, num_block, groups, kernel=(3, 3), stride=(1, 1), padding=(1, 1), se_reduct=4):
        ...
        for i in range(num_block):
            ...
            c3_tuple = c3[i]
            if i == num_block-1:
                modules.append(DepthWiseSE(c1_tuple, c2_tuple, c3_tuple, residual=True, kernel=kernel,
...
class DepthWiseSE(Module):
    """ define the depth wise SE block """
...
class MiniFASNetSE(MiniFASNet):
    """ define the MiniFASNetSE model """
    def __init__(self, keep, embedding_size, conv6_kernel=(7, 7),drop_p=0.75, num_classes=4, img_channel=3):
        super().__init__(keep=keep, embedding_size=embedding_size, conv6_kernel=conv6_kernel,
...
def MiniFASNetV1SE(embedding_size=128, conv6_kernel=(7, 7),
    ...
    """ define the MiniFASNetV1SE model """
...
def MiniFASNetV2SE(embedding_size=128, conv6_kernel=(7, 7),
    ...
    """ define the MiniFASNetV2SE model """
