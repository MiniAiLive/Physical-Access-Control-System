...
if __name__ == '__main__':
    ...
    parser.add_argument('--bin_path', type=str, default="D:/face_data_emore/faces_webface_112x112/lfw.bin")
    parser.add_argument('--save_dir', type=str, default="D:/face_data_emore/faces_webface_112x112/lfw")
