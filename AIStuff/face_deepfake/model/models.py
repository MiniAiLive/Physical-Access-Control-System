...
def return_pytorch04_xception(pretrained=False):
    ...
    if pretrained:
        ...
        state_dict = torch.load('/public/datasets/.torch/models/xception-b5690688.pth')
...
class TransferModel(nn.Module):
    ...
    def __init__(self, modelchoice, num_out_classes=2, dropout=0.5):
        ...
        elif modelchoice in ['resnet50', 'resnet18']:
    ...
    def set_trainable_up_to(self, boolean, layername="Conv2d_4a_3x3"):
        ...
        :param boolean:
        :param layername: depends on model, for inception e.g. Conv2d_4a_3x3
        :return:
        """
        ...
        if boolean:
            ...
            for name, child in self.model.named_children():
                ...
                ct.append(name)
            if not found:
                raise Exception(f'Layer not found, cant finetune! {layername}')
        else:
