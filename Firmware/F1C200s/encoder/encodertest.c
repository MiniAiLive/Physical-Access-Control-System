/*************************************************************************
    ...
    > Author: Daniel
    > Created Time: 2022/05/15 14:51:17
 ************************************************************************/
...
int encoder_main(int src_width, int src_height, int dst_width, int dst_height, int encode_frame_num)
{
    ...
    encode_param.input_format = VENC_PIXEL_YVU420SP;
    encode_param.src_width = src_width;
    encode_param.src_height = src_height;
    encode_param.dst_width = dst_width;
    encode_param.dst_height = dst_height;

    encode_param.encode_frame_num = encode_frame_num;

    strcpy((char*)encode_param.intput_file, "/tmp/pic.dat");
    strcpy((char *)encode_param.output_file, "/tmp");
    ...
    while(testNumber < encode_param.encode_frame_num)
    {
        ...
        /* H264 */
        char jpeg_path[256];
        sprintf(jpeg_path, "%s/test.jpeg", encode_param.output_file, encode_param.dst_width,
